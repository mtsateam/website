...
jQuery(document).ready(function ($) {
    $('.more').on('click', function (event) {
        ...
        var href = $(this).attr('href') + ' .past-events',
...
jQuery(document).ready(function ($) {
    $('.more2').on('click', function (event) {
        ...
        var href = $(this).attr('href') + ' .sponsors',
            discountList = $('#discount-list'),
            content = $('#loaded-content2');

        discountList.animate({
            'marginLeft': '-120%'
        }, {
            duration: 400,
            queue: false
        });
        discountList.fadeOut(400);
        setTimeout(function () {
            $('#loader').show();
        }, 400);
        setTimeout(function () {
    ...
    $('#back-button2').on('click', function (event) {
        ...
        var discountList = $('#discount-list')
        content = $('#loaded-content2');
